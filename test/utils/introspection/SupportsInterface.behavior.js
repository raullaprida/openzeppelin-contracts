...
const SIGNATURES = {
  ...
  Governor: [
    ...
    'version()',
    'COUNTING_MODE()',
    'hashProposal(address[],uint256[],bytes[],bytes32,uint8)',
    'state(uint256)',
    'proposalThreshold()',
    ...
    'queue(address[],uint256[],bytes[],bytes32,uint8)',
    'execute(address[],uint256[],bytes[],bytes32,uint8)',
    'cancel(address[],uint256[],bytes[],bytes32,uint8)',
